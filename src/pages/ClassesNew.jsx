...
export default function Classes() {
  ...
  const addStudent = async (e) => {
    e.preventDefault()
    if (!selectedClassId || !firstName.trim() || !lastName.trim()) return
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  color: activeTab === tab.key ? 'white' : 'var(--fg)',
      ...
      {activeTab === 'students' && (
        <div>
          <div className="panel hover-lift" style={{ marginBottom: '20px' }}>
            ...
            <div className="panel-body">
              <form onSubmit={addStudent} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr auto', gap: '12px', alignItems: 'center' }}>
