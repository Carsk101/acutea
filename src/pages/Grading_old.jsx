                ...
                classes.map(c => (
                  <div 
                    ...
                    style={{ 
                      ...
                      color: selectedClass?.id === c.id ? 'white' : 'var(--fg)',
                  ...
                  <button 
                    ...
                    style={{ 
                      ...
                      background: selectedSubject?.id === s.id 
                        ? 'linear-gradient(135deg, var(--accent-pastel), rgba(45, 106, 79, 0.2))' 
                        : 'rgba(255,255,255,0.8)',
                      color: selectedSubject?.id === s.id ? 'var(--accent)' : 'var(--fg)',
                      border: `2px solid ${selectedSubject?.id === s.id ? 'var(--accent-pastel)' : 'rgba(149, 213, 178, 0.2)'}`,
                      borderRadius: '12px',
                      width: '100%',
                      textAlign: 'left'
                    }}
    ...
    {selectedClass && selectedSubject && (
      <div className="panel" style={{ marginBottom: '24px' }}>
        <div className="panel-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <strong>Categories & Assignments</strong>
          <div style={{ display: 'flex', gap: '8px' }}>
            <a href="/categories" style={{ textDecoration: 'underline' }}>Manage Categories</a>
        ...
        {/* Category Selection */}
        {categories.length === 0 ? (
          <div style={{ padding: '16px', textAlign: 'center', borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
            <p>No categories defined. Please <a href="/categories">create categories</a> first.</p>
          </div>
        ) : (
          <div style={{ padding: '16px', borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {categories.map(category => (
                <button 
                  key={category.id}
                  className={selectedCategory?.id === category.id ? 'primary' : 'outline'}
        ...
        {showNewAssignment && selectedCategory && (
          <div style={{ padding: '16px', borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
            <h4>Add Assignment to {selectedCategory.name}</h4>
            <form onSubmit={addAssignment} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr auto', gap: '12px', alignItems: 'center' }}>
              <input 
